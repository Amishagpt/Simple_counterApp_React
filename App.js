...
function resetHandler() {
  ...
  return (
   <div className="w-[100vw] h-[100vh] flex justify-center bg-[#344151] flex-col gap-10">
    <div className="text-[#0398d4] text-center font-medium text-2xl"> Increment & decrement</div>
    <div className="bg-black flex justify-center gap-12  py-3 rounded-sm text-[25px] text-[#344151]">
